 ...
 *                                       Board Indentifier
 *
 *      Define the Board Identifier to HAL_BOARD_CC2530DEV for END_DEVICE board
 * ------------------------------------------------------------------------------------------------
 */

#if !defined (HAL_BOARD_CC2530DEV) && !defined (HAL_BOARD_CC2530EB_REV13)
#define HAL_BOARD_CC2530DEV
#endif
...
#ifndef LED_POLARITY
  #define LED_POLARITY   ACTIVE_HIGH
#endif
        
/* 0 - LED */
#define LED0_BV           BV(0)
#define LED0_SBIT         P0_0
#define LED0_DIR          P0DIR
#define LED0_POLARITY     LED_POLARITY

/* 1 - LED */
#define LED1_BV           BV(1)
#define LED1_SBIT         P0_1
#define LED1_DIR          P0DIR
#define LED1_POLARITY     LED_POLARITY

/* 2 - LED */
#define LED2_BV           BV(2)
#define LED2_SBIT         P0_2
#define LED2_DIR          P0DIR
#define LED2_POLARITY     LED_POLARITY

/* 3 - LED */
#define LED3_BV             BV(3)
#define LED3_SBIT           P0_3
#define LED3_DIR            P0DIR
#define LED3_POLARITY       LED_POLARITY
...
/* 6 - LED */
#define LED6_BV             BV(6)
#define LED6_SBIT           P0_6
#define LED6_DIR            P0DIR
#define LED6_POLARITY       LED_POLARITY

/* 7 - LED */
#define LED7_BV             BV(7)
#define LED7_SBIT           P0_7
#define LED7_DIR            P0DIR
#define LED7_POLARITY       LED_POLARITY
...
#define PUSH0_SBIT        P0_0
#define PUSH0_POLARITY    PUSH_POLARITY
        
/* S1 */
#define PUSH1_BV          BV(1)
#define PUSH1_SBIT        P0_1
#define PUSH1_POLARITY    PUSH_POLARITY

/* S2 */
#define PUSH2_BV          BV(2)
#define PUSH2_SBIT        P0_2
#define PUSH2_POLARITY    PUSH_POLARITY
        
/* S3 */
#define PUSH3_BV          BV(3)
#define PUSH3_SBIT        P0_3
#define PUSH3_POLARITY    PUSH_POLARITY
...
/* ----------- LED's ---------- */
  ...
  #define HAL_TURN_OFF_LED0()       st( LED0_SBIT = LED0_POLARITY (0); )
